...
## Managing how to put on PPE:

Perform hand hygiene before putting on the PPE.

1. Put on cap, eye cover, surgical mask. Ensure to wear shoe cover/ slippers before entering labour room
2. Put on the gown
3. Put on gloves over cuff

PPE kit for delivering HIV cases should include cap & mask, eye cover and disposable apron.

If performing an aerosol-generating procedure (e.g. intubation or resuscitation), a respirator (E.g. N 95 respirator mask) should be used instead of a medical mask.

![Image](73f13575e7db4d79860e203d94f62a39)
...
![Image](d1a5665d112943c3b0e72a714cdcaebd)

From at least 1 meter away from the woman, remove all PPE in the following order before leaving the room:

1. **Gown and gloves** (Peel off gown and gloves and roll inside out. Dispose safely in appropriate colour coded bags. Separate containers should be available for reusable items). 
...
4. **Mask**(Avoid touching the front of the mask. Remove it by grasping the bottom ties, then discard in an appropriate waste container).  

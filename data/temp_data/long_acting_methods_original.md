...
![Image](0e1734fca1644485b1e112a8735cffc1)
...
![Image](fc8f1042a0c348babff4810c781b6946)

## Removal

A trained provider performs a minor surgical procedure to remove the implant(s).

![Image](42cff17e38fc4a0e98509598a49f7f18)

## Women with HIV

Women who are living with HIV or are on antiretroviral therapy (ART) can safely use implants. However, medications for HIV such as efavirenz, nevirapine and ritonavir may reduce the effectiveness of the implant. Therefore, women with the implant taking ART should also use condoms for better protection against pregnancy.

## Advantages of implants

- No need to do anything once inserted. 
...
# Chapter: Copper Intrauterine Device (IUD)

The copper-IUD is a small, flexible plastic frame with copper sleeves or wire around it, that works by disabling the sperm to prevent fertilization. 

IUDs are one of the most effective (99.2%) and long-lasting methods and can be effective from 5 – 10 years depending on the type. For every 100 women that use an IUD, less than 1 will become pregnant within the first year (6 out of 1,000 women).   

Protection against sexually transmitted infections (STIs): **None** 

Return of fertility after removal: **No delay**

![Image](187381b168334b569db13120d784ff24)

## Insertion

A specifically trained health care provider inserts it into a woman’s uterus through her cervix.

The woman is taught on checking if the IUD is still in place, how to identify symptoms of pelvic infection, and that delayed menstrual periods suggest a possible pregnancy.

## Follow-up

A follow-up appointment is recommended after the first menstrual bleeding or 3-6 weeks after insertion.

## Advantages of copper-IUDs

- Effective pregnancy prevention 
- Long-lasting 
- Private (usually no one else can tell a woman is using contraception, sometimes a partner may feel the strings during sex) 
- No further costs after the IUD is inserted 
- No need to do anything once inserted
- Hormone free method

## Limitations of copper-IUDs
...
Some women reported changes in bleeding patterns, especially within the first 3-6 months (typically more irregular, longer and heavier bleeding, with more painful cramps).
...
# Chapter: Hormonal Intrauterine Device (IUD) or Intrauterine System (IUS)

The hormonal IUD (IUS) is a T-shaped device that steadily releases a small amount of a synthetic hormone, progestin, each day. Progestins, such as levonorgestrel, used in IUSs, mimic the natural hormone progesterone. An IUS works by preventing sperm from reaching and fertilizing the egg. 

The IUS is one of the most effective (99.3%) and long-lasting methods of contraception and can be effective from 3-5 years. For every 100 women that use an IUS, there will be less than 1 pregnancy in the first year (2 out of 1,000 women).
...
An IUS can be placed 4 weeks after giving birth, and sometimes within 48 hours after birth. 

The woman should be taught on checking if the IUS is still in place, how to identify symptoms of pelvic infection, and that delayed menstrual periods suggest a possible pregnancy.

## Follow-up

A follow-up contact is recommended either after the first menstrual bleeding or 3-6 weeks after insertion.
...
Some may develop ovarian cysts (usually resolve without treatment).
...
Risk of pelvic inflammatory disease (PID) if the woman has chlamydia or gonorrhoea at the time of IUS insertion (rare).

## Complications

- Expulsion from the uterus, leading to displacement (rare).
- Damage to the uterus by the IUS or insertion device that usually heals without treatment (rare).
